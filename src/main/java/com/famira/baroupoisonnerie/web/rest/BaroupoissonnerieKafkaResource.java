...
@RestController
@RequestMapping("/api/baroupoissonnerie-kafka")
public class BaroupoissonnerieKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BaroupoissonnerieKafkaResource.class);
    ...
    public BaroupoissonnerieKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
